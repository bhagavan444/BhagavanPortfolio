...
const workshops = [
  {
    ...
    rarity: "Professional",
    desc: "Hands-on MERN stack development internship focused on real-world applications.",
    fullDesc: "Worked on building responsive web applications using React and Node.js. Integrated REST APIs and followed modular coding practices during internship.",
    skills: ["React", "Node.js", "MongoDB", "Express", "REST APIs"],
    whatILearned: [
      "Building responsive React components",
      "Integrating frontend with backend APIs",
      "Working with MongoDB databases",
      "Following modular coding practices",
      "Debugging full-stack applications"
    ],
    outcomes: [
      "Built production-style MERN components",
    ...
    difficulty: 60,
    completionRate: 100,
    certifications: ["MERN Stack  Certificate"],
    rating: 4.6
  },

  {
    ...
    category: "AI / ML",
    rarity: "Professional",
    desc: "Practical machine learning internship focused on data preprocessing and model evaluation.",
    fullDesc: "Worked on real-world datasets involving data cleaning, feature engineering, and training ML models using Python and Scikit-learn.",
...

  {
    ...
    rarity: "Professional",
    desc: "Worked on CNN-based image classification models and Flask deployment.",
    fullDesc: "Built and trained convolutional neural networks using TensorFlow and deployed models via Flask for real-time inference.",
    skills: ["TensorFlow", "Keras", "CNN", "Python", "Flask", "OpenCV"],
    whatILearned: [
    ...
    outcomes: [
      ...
      "Deployed DL models as web apps",
      "Understood end-to-end AI pipelines"
    ],
    duration: "2 Months",
    level: "Intermediate",
    projects: 2,
    ...
    difficulty: 70,
    completionRate: 100,
    certifications: ["AI / ML  Certificate"],
    rating: 4.8
  },

  {
    title: "Full Stack & AI Technical Workshops",
    icon: Workflow,
    color: "#10b981",
    category: "Technical Workshops",
    rarity: "Standard",
    desc: "Participated in multiple technical workshops related to web development and AI.",
    fullDesc: "Attended workshops on Web Development, Deep Learning with TensorFlow, Mobile Application Development, and Introduction to AI & Data Science.",
    skills: ["Web Development", "TensorFlow Basics", "AI Fundamentals", "Mobile App Concepts"],
    whatILearned: [
      "Foundations of AI and Data Science",
      "Introduction to deep learning concepts",
      "Web and mobile application basics",
      "Hands-on exposure through demos"
    ],
    outcomes: [
    ...
    difficulty: 45,
    completionRate: 100,
    certifications: ["Workshop Participation Certificates"],
    rating: 4.4
  }
];
